...
$(OUTDIR)/sd6.md : sd6.py sd6.tmpl macros.yaml reduced.json
	python $< > $@

$(OUTDIR)/sd6.html : $(OUTDIR)/sd6.md
	$(PANDOC) --bibliography $(THIS_DIR)md/wg21_fmt.yaml --bibliography $(DATADIR)/index.yaml --bibliography $(THIS_DIR)md/early.yaml
